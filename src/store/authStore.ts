...
interface AuthState {
  ...
  register: (email: string, password: string, name: string, userType: 'admin' | 'teacher' | 'staff' | 'parent' | 'headteacher' | 'director' | 'schoolDirector' | 'bursar') => Promise<void>
  logout: () => Promise<void>
...
export const useAuthStore = create<AuthState>()(
  persist(
    (set) => ({
      ...
      register: async (email: string, password: string, name: string, userType: 'admin' | 'teacher' | 'staff' | 'parent' | 'headteacher' | 'director' | 'schoolDirector' | 'bursar') => {
        try {
          set({ isLoading: true })
